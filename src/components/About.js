...
export default function About() {
  ...
  return (
    <Box component="section" id="about" sx={{textAlign: 'center', backgroundColor: '#fff', p: 5, pt: 15, px: {lg: 20, xs: 0}, mt: {xl: 9, xs: 12}}}>
      <Typography variant="h1" gutterBottom>About Me</Typography>
      <Box component="div" className='about' sx={{backgroundColor: '#f7f7f7', m: {lg: 0, xs: 10}}}>
      ...
      <Box sx={{backgroundColor: '#f7f7f7', p: {xs: 1, xl: 2}, pb: {xs: 5}, pt: {xs: 1}, textAlign: 'center', display: 'flex', flexDirection: {xs: 'column', xl: 'row'}, justifyContent: 'center', ml: {xs: 10, xl: 0}, mr: {xs: 10, xl: 0}, mt: 15, mb: 10}}>
